namespace AutoScrewSys.Frm
{
    partial class ParameterSettingUI
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ParameterSettingUI));
            ...
            resources.GetString("cbxTorqueUnit.Items2"),
            resources.GetString("cbxTorqueUnit.Items3"),
            resources.GetString("cbxTorqueUnit.Items4")});
            ...
            resources.GetString("cbxDataStoredTime.Items2"),
            resources.GetString("cbxDataStoredTime.Items3"),
            resources.GetString("cbxDataStoredTime.Items4"),
            resources.GetString("cbxDataStoredTime.Items5"),
            resources.GetString("cbxDataStoredTime.Items6")});
            ...
            resources.GetString("cbxLogStoredTime.Items2"),
            resources.GetString("cbxLogStoredTime.Items3"),
            resources.GetString("cbxLogStoredTime.Items4"),
            resources.GetString("cbxLogStoredTime.Items5"),
            resources.GetString("cbxLogStoredTime.Items6")});
            ...
            resources.GetString("cbxLoggedOutTime.Items2"),
            resources.GetString("cbxLoggedOutTime.Items3"),
            resources.GetString("cbxLoggedOutTime.Items4"),
            resources.GetString("cbxLoggedOutTime.Items5"),
            resources.GetString("cbxLoggedOutTime.Items6")});
